// app/components/Tactiques/TactiquesHierarchyView.tsx - AVEC CRÉATIFS COMPLETS ET STRUCTURE VISUELLE CONSERVÉE
...
interface TactiquesHierarchyViewProps {
  ...
  creatifs: { [placementId: string]: Creatif[] }; // 🔥 NOUVEAU : Créatifs par placement
...
export default function TactiquesHierarchyView({
  ...
  // Fonction pour trouver la tactique par son ID
  ...
  // 🔥 NOUVEAU : Fonction pour trouver le placement par son ID
  ...
  // Récupérer les données contextuelles pour les drawers
                                      ...
                                      <div className="pl-8 pb-2 bg-gray-100">
                                        {tactiquePlacements.length === 0 ? (
                                          ...
                                          tactiquePlacements.map((placement) => {
                                            // 🔥 NOUVEAU : Récupérer les créatifs pour ce placement
                                              ...
                                              >
                                                ...
                                                >
                                                  <div className="flex items-center">
                                                    ...
                                                    {/* 🔥 NOUVEAU : Badge avec nombre de créatifs */}
                                                  ...
                                                  <div className="pl-8 bg-white py-1">
                                                    {placementCreatifs.length === 0 ? (
                                                      ...
                                                      placementCreatifs.map((creatif) => (
                                                        ...
                                                        >
                                                          <div className="flex items-center">
                                                            <Bars3Icon className="h-3 w-3 text-gray-300 mr-2" />
                                                            <div className="text-xs text-gray-600">
                                                              🎨 {creatif.CR_Label}
                                                            </div>
                                                            {/* Indicateur de version si présent */}
                                                            {creatif.CR_Version && (
