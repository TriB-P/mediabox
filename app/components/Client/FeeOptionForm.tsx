    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="FO_Option" className="block text-sm font-medium text-gray-700">
          {t('feeOptionForm.labels.optionName')}
        </label>
        <input
          type="text"
          id="FO_Option"
          ...
          placeholder={t('feeOptionForm.placeholders.optionName')}
        />
      </div>

      <div>
        <label htmlFor="FO_Value" className="block text-sm font-medium text-gray-700">
          {t('feeOptionForm.labels.value')}
        </label>
        <input
          type="number"
          id="FO_Value"
      ...
      <div className="flex items-center">
        ...
        <label htmlFor="FO_Editable" className="ml-2 block text-sm text-gray-700">
          {t('feeOptionForm.labels.editable')}
        </label>
      </div>
      ...
      <div className="pt-4 flex justify-end space-x-3">
        ...
        >
          {t('feeOptionForm.buttons.cancel')}
        </button>
        <button
          type="submit"
          className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
          {option ? t('feeOptionForm.buttons.update') : t('feeOptionForm.buttons.add')}
        </button>
      </div>
    </form>
  );
