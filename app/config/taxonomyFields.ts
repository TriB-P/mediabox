...
export const TAXONOMY_VARIABLE_CONFIG: Record<string, VariableConfig> = {
  ...
  'TC_Prog_Buying_Method_1': { source: 'tactique',  allowedFormats: ['code', 'display_fr', 'display_en', 'utm', 'custom_utm', 'custom_code'] },
  'TC_Prog_Buying_Method_2': { source: 'tactique',  allowedFormats: ['code', 'display_fr', 'display_en', 'utm', 'custom_utm', 'custom_code'] },
  ...
  'CR_Custom_Dim_1': { source: 'créatif',  allowedFormats: ['code', 'display_fr', 'display_en', 'utm', 'custom_utm', 'custom_code', 'open'] },
  'CR_Custom_Dim_2': { source: 'créatif',  allowedFormats: ['code', 'display_fr', 'display_en', 'utm', 'custom_utm', 'custom_code', 'open'] },
  'CR_Custom_Dim_3': { source: 'créatif',  allowedFormats: ['code', 'display_fr', 'display_en', 'utm', 'custom_utm', 'custom_code', 'open'] },
  ...
  'CR_Offer': { source: 'créatif',  allowedFormats: ['code', 'display_fr', 'display_en', 'utm', 'custom_utm', 'custom_code', 'open'] },
