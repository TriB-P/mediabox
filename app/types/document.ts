...
export interface Document {
  ...
  /** ID du document original si ce document est une version dissociée */
...
/**
 * Interface pour le résultat de la dissociation d'un document.
 */
export interface DocumentUnlinkResult {
  /** Succès ou échec de la dissociation */
  success: boolean;
  
  /** URL du document dissocié */
  unlinkedUrl?: string;
  
  /** ID du document dissocié dans Google Drive */
  unlinkedFileId?: string;
  ...
  /** Étape où l'erreur s'est produite */
  failedStep?: 'validation' | 'duplication' | 'sheets_deletion' | 'formulas_conversion' | 'renaming' | 'saving';
}